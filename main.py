...
class MyGridLayout(GridLayout):
    def __init__(self, **kwargs):
        ...
        btn1.bind(on_press=self.buytoggled)  # type: ignore
        btn2.bind(on_press=self.selltoggled)  # type: ignore


        self.top_grid.add_widget(
            Label(text="Entry Price(Rs.)", font_size=fontSize))
        ...
        self.top_grid.add_widget(
            Label(text="SL Difference(Rs.)", font_size=fontSize))
        ...
        self.top_grid.add_widget(
            Label(text="SL Trigger Price", font_size=fontSize))
